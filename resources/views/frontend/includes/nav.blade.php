<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    <a href="{{ route('frontend.index') }}" class="navbar-brand">
        <img class="navbar-brand-full" src="{{ asset('images/presqueue.png') }}" width="80" alt="PresQueue Logo">
    </a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @guest
                ...
                @endif
                <li class="nav-item"><a href="{{ route('frontend.business.register') }}" class="nav-link {{ active_class(Route::is('frontend.business.register')) }}">Business Registeration</a></li>
            @else
